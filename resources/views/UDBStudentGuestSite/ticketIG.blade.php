        ...
        <div id="content" class="mt-0 pt-0">            
            <nav class="navbar navbar-expand-lg navbar-light bg-light mt-3 mx-5">
                <div class="container-fluid">                    
                    <a href="{{ route('UDBStaffGuestSite.ticketI') }}" class="btn btn-light" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Regresar">
            ...
            <div class="card mx-5 mb-3">
                <div class="card-body cardBody-Teachers text-center">
                    ...
                    <a href="{{ route('UDBStudentGuestSite.ticketI') }}" class="btn btn-primary mx-2">
                        Inscripción Individual
                    </a>
                   
                    {{-- Botón de inscripción grupal --}}
                    <a href="{{ route('UDBStudentGuestSite.ticketG') }}" class="btn btn-secondary mx-2">
                        Inscripción Grupal
                    </a>
                </div>
            </div>  
