            ...
            <div class="card mx-5 mb-3">
                <div class="card-body cardBody-Teachers">
                    ...
                    @if ($errors->any())
                            ...
                            @endif
                    <form id="entradaForm" method="POST" action="{{ route('UDBStaffGuestSite.storeEntries') }}">
                        @csrf
                        <div class="row mx-1">
                            ...
                            <div class="col-lg-6 col-xs-12">
                                ...
                                <input type="text" id="nivel_educativo" name="nivel_educativo" placeholder="Ingrese su profesión o nivel educativo" class="form-control input"value="{{ $informacionUDB->profesionUDB}}"  required>       
                            </div>
                            <div class="col-lg-6 col-xs-12">
                    ...
                    <table class="table table-striped" id="tablaInformacion">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Nivel Educativo/Profesion</th>
