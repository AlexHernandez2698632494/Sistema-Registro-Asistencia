        ...
        <div id="content" class="mt-0 pt-0">
            <nav class="navbar navbar-expand-lg navbar-light bg-light mt-3 mx-5">
                <div class="container-fluid">
                    <a href="{{ route('UDBStaffGuestSite.site') }}" class="btn btn-light" data-bs-toggle="tooltip"
                    ...
                    <div class="card InfoTitlesSubjectsCard">
                        ...
                        <div class="card-body cardBody-Teachers">
                            ...
                            {{-- Botón de inscripción individual --}}
                                ...
                                <a href="{{ route('UDBStaffGuestSite.ticketG',  $eventInfo->idEvento) }}" class="btn btn-secondary mx-2">
                                    Inscripción Grupal
                                </a>
                            </div>
                        </div>
