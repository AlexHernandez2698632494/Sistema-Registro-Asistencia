								...
								<form method="POST" action="{{ route('storeFirstAdmin') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-6 col-xs-12">
                                            <div class="input-group mb-3">
                                                <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-user"></i></span>
                                                <input type="text" class="form-control" placeholder="Ingrese cargo" aria-label="lastName" name="cargo" value="{{ old('cargo') }}">
                                            </div>
                                        </div>	
                                        <div class="col-lg-12 col-md-6 col-xs-12">
                                            <div class="input-group mb-3">
                                        ...
                                        <div class="col-lg-12 col-md-6 col-xs-12">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="password" class="form-control" placeholder="Ingrese contraseña" aria-label="password" name="password" value="{{ old('password') }}">
                                            </div>
                                        </div>                                 
                                    </div>
									<div class="row">
