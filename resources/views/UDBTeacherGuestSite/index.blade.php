                    ...
                    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                        <div class="card shadow-2-strong" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <form method="POST" action="{{ route('UDBTeacherGuestSite.add') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-12">
									...
									<div class="col-lg-12  col-md-6 col-xs-12">
									 ...
									 <div class="col-lg-12 col-md-6 col-xs-12">
										<div class="input-group mb-3">
											...
											<input type="text" class="form-control" placeholder="Ingrese su carnet" aria-label="carnet" id="txtCarnetUDB" name="carnetUDB" value="{{ old('carnetUDB') }}">
										</div>
									</div>
                                    <div class="col-lg-12  col-md-6 col-xs-12">
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1"><i class="bi bi-mortarboard-fill"></i></span>
											<input type="text" class="form-control" placeholder="Ingrese su Profesion" aria-label="carnet" id="txtprofesionUDB" name="profesionUDB" value="{{ old('profesionUDB') }}">
										</div>
									</div>
									<div class="col-lg-12 col-md-6 col-xs-12">
										<div class="input-group mb-3">
