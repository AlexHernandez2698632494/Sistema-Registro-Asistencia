                            ...
                            @endif
                                <div class="col-lg-12 col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ingrese su nombre" aria-label="name" name="nombreInvitado" value="{{ old('nombreInvitado') }}">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-user"></i></span>
                                        <input type="text" class="form-control" placeholder="Ingrese su apellido" aria-label="lastName" name="apellidosInvitado" value="{{ old('apellidosInvitado') }}">
                                    </div>
                                </div>
                                <div class="col-lg-12  col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                 ...
                                 <div class="col-lg-12 col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ingrese su DUI" aria-label="duiInvitado" id="txtDui" name="duiInvitado" value="{{ old('duiInvitado') }}">
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-envelope"></i></span>
                                        <input type="email" class="form-control" placeholder="Ingrese su correo" aria-label="correoInvitado" name="correoInvitado" value="{{ old('correoInvitado') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12  col-md-6 col-xs-12">
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1"><i class="fa-solid fa-map-location-dot"></i></span>
                                        <select class="form-select" aria-label="Default select example" id="txtmunicipio" name="municipio">
								...
								{{-- <div class="row justify-content">
									<div class="col-lg-6 col-xs-12 mt-2">                                    
										...
										<input type="text" id="nombre" name="nombre" placeholder="Ingrese su nombre" class="form-control input"  value="{{old('nombre')}}" required>                                    
									</div>
									<div class="col-lg-6 col-xs-12 mt-2">
										<label for="apellido" class="form-label">Apellido</label>                                
										<input type="text" id="Apellido" name="apellido" placeholder="Ingrese su apellido" class="form-control input" value="{{old('apellido')}}" required>
									</div>
								</div>          
								<div class="row mt-2 justify-content-center">
									<div class="col-lg-6 col-xs-12 mt-2">
										<label for="duiInvitado" class="form-label">duiInvitado</label>                                
										<input type="text" class="form-control" placeholder="Ingrese su duiInvitado" aria-label="duiInvitado" id="txtduiInvitado" name="duiInvitado" value="{{old('duiInvitado')}}">
								</div>
									<div class="col-lg-6 col-xs-12 mt-2">
										<label for="telefonoInvitado" class="form-label">Número de teléfono</label>                                
										<input type="text" class="form-control txtPhone" id="txtPhone" placeholder="Ingrese su número de teléfono" aria-label="phone" name="telefonoInvitado" value="{{old('telefonoInvitado')}}">
									</div>                                
								</div>  
								<div class="row mt-2 justify-content">
									<div class="col-lg-6 col-xs-12 mt-2">                                    
										<label for="direccion" class="form-label">Direccion</label>                                
										<input type="text" id="direccion" name="direccion" placeholder="Ingrese su direccion" class="form-control input"  value="{{old('direccion')}}" >                                    
									</div>
									<div class="col-lg-6 col-xs-12 mt-2">                                    
										<label for="correoInvitado" class="form-label">correoInvitado electrónico</label>                                
										<input type="email" id="correoInvitado"  placeholder="Ingrese su correoInvitado" name="correoInvitado" class="form-control  input" value="{{old('correoInvitado')}}" required>                                    
									</div>
								</div> --}}
