...
class UsuarioController extends Controller
{
    ...
    public function index(){
        ...
        $docentesUDB = DB::table('usuario')->join('docenteUDB','usuario.idusuario','=','docenteUDB.carnetUDB')->where('usuario.nivel','=',4)->get();
        ...
        //return $invitados;
        return view('users.index',compact('invitados','estudiantesUDB','administradores','estudiantesOtra','docentesUDB','personalesUDB'));
    }
